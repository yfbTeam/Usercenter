<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="UCSWeb.Organiz.WebForm1" %>
...
<head>
    ...
    <link href="../Scripts/zTree/demo.css" rel="stylesheet" />
...
<body>
    ...
    <div class="content_wrap">
        ...
        <div class="right">
            <ul class="info">
                <li class="title">
                    <h2>Explanation of implementation method</h2>
                    <ul class="list">
